...
vim.keymap.set('n', '<Space>gsb', '<cmd>Gitsigns blame<cr>', { desc = "Git blame" })
vim.keymap.set('n', '<Space>gsB', '<cmd>Gitsigns toggle_current_line_blame<cr>', { desc = "Git blame (current blame)" })
